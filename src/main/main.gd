...
@onready var card_status_badge: Label = $Margin/Page/StudyFlow/StudyContainer/CardStage/CardSlot/CardFrame/CardMargin/CardContent/CardProperties/StatusBadge
@onready var question_scroll: ScrollContainer = $Margin/Page/StudyFlow/StudyContainer/CardStage/CardSlot/CardFrame/CardMargin/CardContent/QuestionScroll
@onready var question_label: Label = $Margin/Page/StudyFlow/StudyContainer/CardStage/CardSlot/CardFrame/CardMargin/CardContent/QuestionScroll/QuestionLabel
@onready var answer_label: Label = $Margin/Page/StudyFlow/StudyContainer/CardStage/CardSlot/CardFrame/CardMargin/CardContent/AnswerScroll/AnswerLabel
@onready var answer_scroll: ScrollContainer = $Margin/Page/StudyFlow/StudyContainer/CardStage/CardSlot/CardFrame/CardMargin/CardContent/AnswerScroll
